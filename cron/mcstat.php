...
class HytaleStatus
{
    ...
    function __construct($hostname, $port=25565)
    {
        ...
        $this->methodTable = array(
            self::SERVER_LIST_PING     => array('HytaleServerListPing', 'ping'),
            self::SERVER_LIST_PING_1_7 => array('HytaleServerListPing', 'ping17'),
            self::BASIC_QUERY          => array('HytaleQuery', 'basicQuery'),
            self::FULL_QUERY           => array('HytaleQuery', 'fullQuery'),
        );
    }
...
/*
  ...
  An example of how to get a Hytale server status's using a "Server List Ping" packet.
  See details here: http://www.wiki.vg/Server_List_Ping
*/

class HytaleServerListPing
{
...
/*
  ...
  This section utilizes the UT3 Query protocol to query a Hytale server.
